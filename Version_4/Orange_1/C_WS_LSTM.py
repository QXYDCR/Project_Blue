...
# 加载pos, neg词典
pos_dict_file = 'C:/Users/Chihiro/Desktop/RL Paper/Git Code/Code 102/Project_Blue/' \
                'Version_3/Emotion_Dict/dict/positive.txt'
neg_dict_file = 'C:/Users/Chihiro/Desktop/RL Paper/Git Code/Code 102/Project_Blue/' \
                'Version_3/Emotion_Dict/dict/negative.txt'
...
actor_criterion = torch.nn.NLLLoss(reduction = 'none')

class Critic(nn.Module):
    def __init__(self, vocab_size=len(vocab), embedding_dim=50, hidden_size=50,
                 pretrained_embed=word2vec, is_updata_w2c=False, n_class=3, batch = BATCH):
...
for epoch in range(5):
    for i, data in enumerate(zip(train_data, train_label)):
        ...
        # 计算回合的得分, 每个步骤都有分
        scores = get_episode_score(I, pred_actions.numpy())
        ...
        loss_actor = -R  * selected_logprobs.mean()
        ...
        if i % 400 == 0:
            ...
            print('epoch: {}, 数据准确率: {:.5f}\tloss: {:.5f}\treward: {:.5f}'.
