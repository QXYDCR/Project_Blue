...
word2vec = build_word2vec(word2vec_path, word2id)
...
# 加载训练用的数据
train_dataset = TensorDataset(torch.FloatTensor(contents), torch.LongTensor(labels))
...
# 加载测试集
test_dataset = TensorDataset(torch.LongTensor(test_contents), torch.LongTensor(test_labels))
